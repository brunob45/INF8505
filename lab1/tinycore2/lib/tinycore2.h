/*
-- File : tinycore2.h (final version)
--
...
// ---------------------------------
    ...
    class spidx      property( 6 bit signed min=-32 max=-1); // SP index
...
// Control operations
    ...
    void doloop(word,sbyte)   property(relative doloop);
#if !defined(__programmers_view__)
    word pc_add(word,sbyte);
#endif
