// File generated by checkers version 08R1 6.1.7, Fri Dec 19 15:44:26 2008
// Copyright(c) 1996-2008 Target Compiler Technologies N.V.
// All rights reserved.

// Processor: tinycore2

#ifndef __tinycore2_iapcu_user_c__
#define __tinycore2_iapcu_user_c__
...
inline void tinycore2_user_next_pc(tinycore* mdl, unsigned next_pc, unsigned nw, Checkers_next_pc_type npt)
{
    /* User code here */
    mdl->PC = next_pc;
}
...
// 
inline unsigned tinycore2_loop_end(tinycore* mdl, unsigned nw)
{
    /* User code here */
    if (mdl->LC.to_unsigned() != 1) { // jump back
        mdl->LC = mdl->LC.to_unsigned() - 1;
        return mdl->LS.to_unsigned();
    }
