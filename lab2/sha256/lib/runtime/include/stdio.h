...
// For implementation reasons, all 'size' arguments simply have type int
// instead of size_t.
...
extern int snprintf(char *str, int size, const char *format, ...) property(loop_free);
extern int vsprintf(char *str, const char *format, va_list ap) property(loop_free);
extern int vsnprintf(char *str, int size, const char *format, va_list ap) property(loop_free);
...
extern int fwrite(const void chess_storage(DMb)* ptr, int size, int nmemb, FILE* stream) property(loop_free); 

extern int fread(void chess_storage(DMb)* ptr, int size, int nmemb, FILE* stream) property(loop_free);
...
extern int fwrite_word(const void chess_storage(DMb)* ptr, int size, int nword, int lsb_first, FILE* stream) property(loop_free); 

extern int fread_word(void chess_storage(DMb)* ptr, int size, int nword, int lsb_first, FILE* stream) property(loop_free);
