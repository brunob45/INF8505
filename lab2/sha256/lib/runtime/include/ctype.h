...
const unsigned char _ct_L = 0x01;  // lower case letter
const unsigned char _ct_U = 0x02;  // upper case letter
const unsigned char _ct_D = 0x04;  // digit
const unsigned char _ct_X = 0x08;  // hexadecimal digit
const unsigned char _ct_P = 0x10;  // punctuation
const unsigned char _ct_C = 0x20;  // control character
const unsigned char _ct_S = 0x40;  // white space character
const unsigned char _ct_B = 0x80;  // blank character

extern unsigned char _ct_code[];
