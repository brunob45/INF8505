...
extern tlx_primitive::iword chess_storage(PM) o_PM;
void chess_storage(PM) * ctptr_PM() { return &o_PM; }

extern tlx_primitive::w08 chess_storage(DMb) o_DMb;
void chess_storage(DMb) * ctptr_DMb() { return &o_DMb; }

extern tlx_primitive::w08 chess_storage(DMb_stat) o_DMb_stat;
