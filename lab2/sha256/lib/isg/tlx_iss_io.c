...
#define CHESS_NATIVE_FAIL(msg) return (std::cerr << "error: in dbl2expo: literal " << d << " : " << msg << std::endl), 0/*ERROR*/
                       ...
                       int expo, int sexp, int layo, int mbit, int zexp)
{
    ...
    if (layo == 3) { // ieee
        if (bits == 32) {
            ...
            CHESS_NATIVE_FAIL("ieee format only supported for 32 and 64 bit");
    }
    ...
    int exp;
#ifdef _MSC_VER
    unsigned long long sfcd =
        (unsigned long long)ldexp(frexp(copysign(d,1.0),&exp),64-1);
    sfcd <<= 1; //otherwise saturates as if signed
#else
    unsigned long long sfcd =
        (unsigned long long)ldexp(frexp(copysign(d,1.0),&exp),64);
#endif
    ...
    if (shift_factor >= 0) {                    // shift and round
        unsigned long long rbit;
        if (shift_factor < 64) {
            bpat = sfcd >> shift_factor;
            rbit = CHESS_NATIVE_ONEULL << (shift_factor-1);
        }
        else {
            bpat = 0;
            rbit = (shift_factor == 64 ? CHESS_NATIVE_ONEULL << 63 : 0);
        }
        if (sfcd & rbit) {                      // rounding away from zero
            bpat += CHESS_NATIVE_ONEULL;
            if (bpat & (CHESS_NATIVE_ONEULL << m_bits)) { bpat >>= 1; exp += 1; }
        }
    }
    else
    ...
    // denormalisation
    if (e_exp <= e_min) {
        int denorm_factor = -e_exp + e_min;
        int denorm_shift = denorm_factor + (!mbit_impl ? 0 : 1);
        if (denorm_factor < m_bits) {
            e_exp += denorm_factor;
            if (denorm_shift) {
                bpat >>= denorm_shift - 1;
                if (bpat & CHESS_NATIVE_ONEULL) bpat += CHESS_NATIVE_ONEULL;      // round to precision
                bpat >>= 1;                             // after rounding
            }
            //else possible?
        }
        else
...
#endif
#ifdef checkers_[=getdesign_name=]_RA_si
# define chess_[=getdesign_name=]_RA_si checkers_[=getdesign_name=]_RA_si
#else
# define chess_[=getdesign_name=]_RA_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RB_si
# define chess_[=getdesign_name=]_RB_si checkers_[=getdesign_name=]_RB_si
#else
# define chess_[=getdesign_name=]_RB_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RC_si
# define chess_[=getdesign_name=]_RC_si checkers_[=getdesign_name=]_RC_si
#else
# define chess_[=getdesign_name=]_RC_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RD_si
# define chess_[=getdesign_name=]_RD_si checkers_[=getdesign_name=]_RD_si
#else
# define chess_[=getdesign_name=]_RD_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RE_si
# define chess_[=getdesign_name=]_RE_si checkers_[=getdesign_name=]_RE_si
#else
# define chess_[=getdesign_name=]_RE_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RF_si
# define chess_[=getdesign_name=]_RF_si checkers_[=getdesign_name=]_RF_si
#else
# define chess_[=getdesign_name=]_RF_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RG_si
# define chess_[=getdesign_name=]_RG_si checkers_[=getdesign_name=]_RG_si
#else
# define chess_[=getdesign_name=]_RG_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_RH_si
# define chess_[=getdesign_name=]_RH_si checkers_[=getdesign_name=]_RH_si
#else
# define chess_[=getdesign_name=]_RH_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_R11_si
# define chess_[=getdesign_name=]_R11_si checkers_[=getdesign_name=]_R11_si
#else
# define chess_[=getdesign_name=]_R11_si (-1)
#endif
#ifdef checkers_[=getdesign_name=]_R12_si
# define chess_[=getdesign_name=]_R12_si checkers_[=getdesign_name=]_R12_si
#else
# define chess_[=getdesign_name=]_R12_si (-1)
#endif
...
int [=getdesign_name=]_read0_pad16(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return chkapi_errorsp->put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_read0_pad16");
    DataType vval = sti->vbit(0);
    int rt = chkapi_l_storage_get_vbit(uicore, sta, vval);
    val[0] = vval.to_signedVBitWrapper().to_longlong();
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read value", "[=getdesign_name=]_read0_pad16");
...
int [=getdesign_name=]_write0_pad16(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    Checkers_storage* sti = uicore->core()->storinfo(si);
    if (!sti)
        return chkapi_errorsp->put(chkapi_ERR, "Illegal storage index ", "[=getdesign_name=]_write0_pad16");
    DataType vval = sti->vbit((int)tval[0]);
    int rt = chkapi_l_storage_put_vbit(uicore, sta, vval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write value", "[=getdesign_name=]_write0_pad16");
    return chkapi_OK;
}
...
int [=getdesign_name=]_read1_record0(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record0");
...
int [=getdesign_name=]_write1_record0(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record0");
    // complete
    return chkapi_OK;
}
...
int [=getdesign_name=]_read1_record3(Checkers_uicore* uicore, long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of record value", "[=getdesign_name=]_read1_record3");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, si, addr + 1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of record value", "[=getdesign_name=]_read1_record3");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    // complete
    return chkapi_OK;
}
...
int [=getdesign_name=]_write1_record3(Checkers_uicore* uicore, const long long* val, int /*n=1*/, int si, AddressType addr)
{
    ...
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 0 of record value", "[=getdesign_name=]_write1_record3");
    // component 1 : 32 bits at 0
    fval[0] = CHESS_EXTENDLL(tval[0] >> 0, 32);
    rt = [=getdesign_name=]_write0(uicore, fval,1, si, addr + 1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write component 1 of record value", "[=getdesign_name=]_write1_record3");
    // complete
    return chkapi_OK;
}
...
int [=getdesign_name=]_readstring0(Checkers_uicore* uicore, std::string& val, int si, int csz, AddressType addr)
{
    ...
    while (1) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read character from string", "tlx_readstring0");
        if (!cval) break;
        val += (char)(cval & 0xff);
        addr += csz;
    }
...
int [=getdesign_name=]_writestring0(Checkers_uicore* uicore, std::string val, int si, int csz, AddressType addr, int term_zero)
{
    for (unsigned i = 0; i < val.length(); i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write character from string", "tlx_writestring0");
        addr += csz;
    }
    if (term_zero) {
        long long cval = 0;
        int rt = [=getdesign_name=]_write0(uicore, &cval,1, si, addr);
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write terminating zero from string", "tlx_writestring0");
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb_bool(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get bool value", "[=getdesign_name=]_get_DMb_bool");
...
int [=getdesign_name=]_put_DMb_bool(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_bool");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put bool value", "[=getdesign_name=]_put_DMb_bool");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb_bool(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get bool value", "[=getdesign_name=]_getalt_DMb_bool");
    uval = CHESS_MASKLL(val,1);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb_bool(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_bool");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put bool value", "[=getdesign_name=]_putalt_DMb_bool");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___cchar(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get char value", "[=getdesign_name=]_get_DMb___cchar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___cchar(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___cchar");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put char value", "[=getdesign_name=]_put_DMb___cchar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___cchar(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get char value", "[=getdesign_name=]_getalt_DMb___cchar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___cchar(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___cchar");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put char value", "[=getdesign_name=]_putalt_DMb___cchar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___schar(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get signed char value", "[=getdesign_name=]_get_DMb___schar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___schar(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___schar");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put signed char value", "[=getdesign_name=]_put_DMb___schar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___schar(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get signed char value", "[=getdesign_name=]_getalt_DMb___schar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___schar(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___schar");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put signed char value", "[=getdesign_name=]_putalt_DMb___schar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___uchar(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned char value", "[=getdesign_name=]_get_DMb___uchar");
...
int [=getdesign_name=]_put_DMb___uchar(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___uchar");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned char value", "[=getdesign_name=]_put_DMb___uchar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___uchar(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned char value", "[=getdesign_name=]_getalt_DMb___uchar");
    uval = CHESS_MASKLL(val,8);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___uchar(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___uchar");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned char value", "[=getdesign_name=]_putalt_DMb___uchar");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___sshort(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get short value", "[=getdesign_name=]_get_DMb___sshort");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___sshort(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___sshort");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put short value", "[=getdesign_name=]_put_DMb___sshort");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___sshort(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get short value", "[=getdesign_name=]_getalt_DMb___sshort");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___sshort(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___sshort");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put short value", "[=getdesign_name=]_putalt_DMb___sshort");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___ushort(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned short value", "[=getdesign_name=]_get_DMb___ushort");
...
int [=getdesign_name=]_put_DMb___ushort(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___ushort");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned short value", "[=getdesign_name=]_put_DMb___ushort");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___ushort(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned short value", "[=getdesign_name=]_getalt_DMb___ushort");
    uval = CHESS_MASKLL(val,16);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___ushort(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___ushort");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned short value", "[=getdesign_name=]_putalt_DMb___ushort");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___sint(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_get_DMb___sint");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___sint(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___sint");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put int value", "[=getdesign_name=]_put_DMb___sint");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___sint(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getalt_DMb___sint");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___sint(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___sint");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put int value", "[=getdesign_name=]_putalt_DMb___sint");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___uint(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned value", "[=getdesign_name=]_get_DMb___uint");
...
int [=getdesign_name=]_put_DMb___uint(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___uint");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned value", "[=getdesign_name=]_put_DMb___uint");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___uint(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned value", "[=getdesign_name=]_getalt_DMb___uint");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___uint(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___uint");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned value", "[=getdesign_name=]_putalt_DMb___uint");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___slong(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get long value", "[=getdesign_name=]_get_DMb___slong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___slong(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___slong");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put long value", "[=getdesign_name=]_put_DMb___slong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___slong(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get long value", "[=getdesign_name=]_getalt_DMb___slong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___slong(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___slong");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put long value", "[=getdesign_name=]_putalt_DMb___slong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___ulong(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned long value", "[=getdesign_name=]_get_DMb___ulong");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___ulong(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___ulong");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned long value", "[=getdesign_name=]_put_DMb___ulong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___ulong(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned long value", "[=getdesign_name=]_getalt_DMb___ulong");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___ulong(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___ulong");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned long value", "[=getdesign_name=]_putalt_DMb___ulong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___slonglong(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get long long value", "[=getdesign_name=]_get_DMb___slonglong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___slonglong(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___slonglong");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put long long value", "[=getdesign_name=]_put_DMb___slonglong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___slonglong(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get long long value", "[=getdesign_name=]_getalt_DMb___slonglong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___slonglong(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___slonglong");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put long long value", "[=getdesign_name=]_putalt_DMb___slonglong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___ulonglong(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned long long value", "[=getdesign_name=]_get_DMb___ulonglong");
    uval = val;
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___ulonglong(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___ulonglong");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned long long value", "[=getdesign_name=]_put_DMb___ulonglong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___ulonglong(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get unsigned long long value", "[=getdesign_name=]_getalt_DMb___ulonglong");
    uval = val;
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___ulonglong(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___ulonglong");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put unsigned long long value", "[=getdesign_name=]_putalt_DMb___ulonglong");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___ffloat(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get float value", "[=getdesign_name=]_get_DMb___ffloat");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___ffloat(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___ffloat");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put float value", "[=getdesign_name=]_put_DMb___ffloat");
    return chkapi_OK;
}
...
int [=getdesign_name=]_gete_DMb___ffloat(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get encoded float value", "[=getdesign_name=]_gete_DMb___ffloat");
    val = checkers_expo_to_double(eval, 32, 2, 8, 3, 0, 0, 0);
    return chkapi_OK;
}
...
{
    long long eval;
    int rt = checkers_floating_encoded_value(val, 32, 2, 0, 8, 3, 0, 0, 0, eval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not encode float value", "[=getdesign_name=]_pute_DMb___ffloat");
    rt = [=getdesign_name=]_put_DMb___ffloat(uicore, eval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put encoded float value", "[=getdesign_name=]_pute_DMb___ffloat");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___ffloat(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get float value", "[=getdesign_name=]_getalt_DMb___ffloat");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___ffloat(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___ffloat");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put float value", "[=getdesign_name=]_putalt_DMb___ffloat");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getealt_DMb___ffloat(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get encoded float value", "[=getdesign_name=]_getealt_DMb___ffloat");
    val = checkers_expo_to_double(eval, 32, 2, 8, 3, 0, 0, 0);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putealt_DMb___ffloat(Checkers_uicore* uicore, double val, AddressType& addr)
{
    ...
    int rt = checkers_floating_encoded_value(val, 32, 2, 0, 8, 3, 0, 0, 0, eval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not encode float value", "[=getdesign_name=]_putealt_DMb___ffloat");
    rt = [=getdesign_name=]_putalt_DMb___ffloat(uicore, eval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put encoded float value", "[=getdesign_name=]_putealt_DMb___ffloat");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___fdouble(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get double value", "[=getdesign_name=]_get_DMb___fdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___fdouble(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___fdouble");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put double value", "[=getdesign_name=]_put_DMb___fdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_gete_DMb___fdouble(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get encoded double value", "[=getdesign_name=]_gete_DMb___fdouble");
    val = checkers_expo_to_double(eval, 64, 2, 11, 3, 0, 0, 0);
    return chkapi_OK;
}
...
{
    long long eval;
    int rt = checkers_floating_encoded_value(val, 64, 2, 0, 11, 3, 0, 0, 0, eval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not encode double value", "[=getdesign_name=]_pute_DMb___fdouble");
    rt = [=getdesign_name=]_put_DMb___fdouble(uicore, eval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put encoded double value", "[=getdesign_name=]_pute_DMb___fdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___fdouble(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get double value", "[=getdesign_name=]_getalt_DMb___fdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___fdouble(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___fdouble");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put double value", "[=getdesign_name=]_putalt_DMb___fdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getealt_DMb___fdouble(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get encoded double value", "[=getdesign_name=]_getealt_DMb___fdouble");
    val = checkers_expo_to_double(eval, 64, 2, 11, 3, 0, 0, 0);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putealt_DMb___fdouble(Checkers_uicore* uicore, double val, AddressType& addr)
{
    ...
    int rt = checkers_floating_encoded_value(val, 64, 2, 0, 11, 3, 0, 0, 0, eval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not encode double value", "[=getdesign_name=]_putealt_DMb___fdouble");
    rt = [=getdesign_name=]_putalt_DMb___fdouble(uicore, eval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put encoded double value", "[=getdesign_name=]_putealt_DMb___fdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___flongdouble(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get long double value", "[=getdesign_name=]_get_DMb___flongdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___flongdouble(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___flongdouble");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put long double value", "[=getdesign_name=]_put_DMb___flongdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_gete_DMb___flongdouble(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get encoded long double value", "[=getdesign_name=]_gete_DMb___flongdouble");
    val = checkers_expo_to_double(eval, 64, 2, 11, 3, 0, 0, 0);
    return chkapi_OK;
}
...
int [=getdesign_name=]_pute_DMb___flongdouble(Checkers_uicore* uicore, double val, AddressType& addr)
{
    ...
    int rt = checkers_floating_encoded_value(val, 64, 2, 0, 11, 3, 0, 0, 0, eval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not encode long double value", "[=getdesign_name=]_pute_DMb___flongdouble");
    rt = [=getdesign_name=]_put_DMb___flongdouble(uicore, eval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put encoded long double value", "[=getdesign_name=]_pute_DMb___flongdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___flongdouble(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get long double value", "[=getdesign_name=]_getalt_DMb___flongdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___flongdouble(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___flongdouble");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write1_record0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put long double value", "[=getdesign_name=]_putalt_DMb___flongdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getealt_DMb___flongdouble(Checkers_uicore* uicore, double& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get encoded long double value", "[=getdesign_name=]_getealt_DMb___flongdouble");
    val = checkers_expo_to_double(eval, 64, 2, 11, 3, 0, 0, 0);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putealt_DMb___flongdouble(Checkers_uicore* uicore, double val, AddressType& addr)
{
    ...
    int rt = checkers_floating_encoded_value(val, 64, 2, 0, 11, 3, 0, 0, 0, eval);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not encode long double value", "[=getdesign_name=]_putealt_DMb___flongdouble");
    rt = [=getdesign_name=]_putalt_DMb___flongdouble(uicore, eval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put encoded long double value", "[=getdesign_name=]_putealt_DMb___flongdouble");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___Pvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void * value", "[=getdesign_name=]_get_DMb___Pvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___Pvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___Pvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void * value", "[=getdesign_name=]_put_DMb___Pvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___Pvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void * value", "[=getdesign_name=]_getalt_DMb___Pvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___Pvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___Pvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void * value", "[=getdesign_name=]_putalt_DMb___Pvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PPMvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(PM) * value", "[=getdesign_name=]_get_DMb___PPMvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PPMvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PPMvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(PM) * value", "[=getdesign_name=]_put_DMb___PPMvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PPMvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(PM) * value", "[=getdesign_name=]_getalt_DMb___PPMvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PPMvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PPMvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(PM) * value", "[=getdesign_name=]_putalt_DMb___PPMvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PDMbvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMb) * value", "[=getdesign_name=]_get_DMb___PDMbvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PDMbvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PDMbvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMb) * value", "[=getdesign_name=]_put_DMb___PDMbvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PDMbvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMb) * value", "[=getdesign_name=]_getalt_DMb___PDMbvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PDMbvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PDMbvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMb) * value", "[=getdesign_name=]_putalt_DMb___PDMbvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PDMhvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMh) * value", "[=getdesign_name=]_get_DMb___PDMhvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PDMhvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PDMhvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMh) * value", "[=getdesign_name=]_put_DMb___PDMhvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PDMhvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMh) * value", "[=getdesign_name=]_getalt_DMb___PDMhvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PDMhvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PDMhvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMh) * value", "[=getdesign_name=]_putalt_DMb___PDMhvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PDMwvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMw) * value", "[=getdesign_name=]_get_DMb___PDMwvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PDMwvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PDMwvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMw) * value", "[=getdesign_name=]_put_DMb___PDMwvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PDMwvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMw) * value", "[=getdesign_name=]_getalt_DMb___PDMwvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PDMwvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PDMwvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMw) * value", "[=getdesign_name=]_putalt_DMb___PDMwvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PDMb_statvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMb_stat) * value", "[=getdesign_name=]_get_DMb___PDMb_statvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PDMb_statvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PDMb_statvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMb_stat) * value", "[=getdesign_name=]_put_DMb___PDMb_statvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PDMb_statvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMb_stat) * value", "[=getdesign_name=]_getalt_DMb___PDMb_statvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PDMb_statvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PDMb_statvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMb_stat) * value", "[=getdesign_name=]_putalt_DMb___PDMb_statvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PDMh_statvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMh_stat) * value", "[=getdesign_name=]_get_DMb___PDMh_statvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PDMh_statvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PDMh_statvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMh_stat) * value", "[=getdesign_name=]_put_DMb___PDMh_statvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PDMh_statvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMh_stat) * value", "[=getdesign_name=]_getalt_DMb___PDMh_statvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PDMh_statvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PDMh_statvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMh_stat) * value", "[=getdesign_name=]_putalt_DMb___PDMh_statvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb___PDMw_statvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMw_stat) * value", "[=getdesign_name=]_get_DMb___PDMw_statvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb___PDMw_statvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb___PDMw_statvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMw_stat) * value", "[=getdesign_name=]_put_DMb___PDMw_statvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb___PDMw_statvoid(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get void chess_storage(DMw_stat) * value", "[=getdesign_name=]_getalt_DMb___PDMw_statvoid");
    uval = CHESS_MASKLL(val,32);
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb___PDMw_statvoid(Checkers_uicore* uicore, unsigned long long uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb___PDMw_statvoid");
    AddressType ptr(pval);
    long long val = uval;
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put void chess_storage(DMw_stat) * value", "[=getdesign_name=]_putalt_DMb___PDMw_statvoid");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb_w08(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get w08 value", "[=getdesign_name=]_get_DMb_w08");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb_w08(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_w08");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put w08 value", "[=getdesign_name=]_put_DMb_w08");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb_w08(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get w08 value", "[=getdesign_name=]_getalt_DMb_w08");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb_w08(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_w08");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put w08 value", "[=getdesign_name=]_putalt_DMb_w08");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb_w16(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get w16 value", "[=getdesign_name=]_get_DMb_w16");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb_w16(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_w16");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put w16 value", "[=getdesign_name=]_put_DMb_w16");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb_w16(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get w16 value", "[=getdesign_name=]_getalt_DMb_w16");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb_w16(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_w16");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMh(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put w16 value", "[=getdesign_name=]_putalt_DMb_w16");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb_w32(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get w32 value", "[=getdesign_name=]_get_DMb_w32");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb_w32(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_w32");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put w32 value", "[=getdesign_name=]_put_DMb_w32");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb_w32(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get w32 value", "[=getdesign_name=]_getalt_DMb_w32");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb_w32(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_w32");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put w32 value", "[=getdesign_name=]_putalt_DMb_w32");
    return chkapi_OK;
}
...
int [=getdesign_name=]_get_DMb_int16p(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int16p value", "[=getdesign_name=]_get_DMb_int16p");
    return chkapi_OK;
}
...
int [=getdesign_name=]_put_DMb_int16p(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_put_DMb_int16p");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_pad16_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put int16p value", "[=getdesign_name=]_put_DMb_int16p");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getalt_DMb_int16p(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_read0_pad16_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int16p value", "[=getdesign_name=]_getalt_DMb_int16p");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putalt_DMb_int16p(Checkers_uicore* uicore, long long val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get pointer argument", "[=getdesign_name=]_putalt_DMb_int16p");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_write0_pad16_DMw(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not put int16p value", "[=getdesign_name=]_putalt_DMb_int16p");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getstring_DMb(Checkers_uicore* uicore, std::string& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get string pointer", "[=getdesign_name=]_getstring_DMb");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_readstring_DMb(uicore, val, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read string", "[=getdesign_name=]_getstring_DMb");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putstring_DMb(Checkers_uicore* uicore, std::string val, AddressType& addr, int term_zero)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get string pointer", "[=getdesign_name=]_putstring_DMb");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_writestring_DMb(uicore, val, ptr, term_zero);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write string", "[=getdesign_name=]_putstring_DMb");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getstringalt_DMb(Checkers_uicore* uicore, std::string& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get string pointer", "[=getdesign_name=]_getstringalt_DMb");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_readstring_DMb(uicore, val, ptr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read string", "[=getdesign_name=]_getstringalt_DMb");
    return chkapi_OK;
}
...
int [=getdesign_name=]_putstringalt_DMb(Checkers_uicore* uicore, std::string val, AddressType& addr, int term_zero)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___PDMbvoid(uicore, pval, addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get string pointer", "[=getdesign_name=]_putstringalt_DMb");
    AddressType ptr(pval);
    rt = [=getdesign_name=]_writestring_DMb(uicore, val, ptr, term_zero);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not write string", "[=getdesign_name=]_putstringalt_DMb");
    return chkapi_OK;
}
...
int [=getdesign_name=]_getp_DMb___sshort(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getp_DMb___sshort");
...
int [=getdesign_name=]_getpalt_DMb___sshort(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getpalt_DMb___sshort");
    val = CHESS_EXTENDLL(pval,16);
    return chkapi_OK;
}
...
int [=getdesign_name=]_getp_DMb___ushort(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___sint(uicore,pval,addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getp_DMb___ushort");
...
int [=getdesign_name=]_getpalt_DMb___ushort(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___sint(uicore,pval,addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getpalt_DMb___ushort");
    uval = CHESS_MASKLL(pval,16);
    return chkapi_OK;
}
...
int [=getdesign_name=]_getp_DMb___schar(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___sint(uicore,pval,addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getp_DMb___schar");
...
int [=getdesign_name=]_getpalt_DMb___schar(Checkers_uicore* uicore, long long& val, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___sint(uicore,pval,addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getpalt_DMb___schar");
    val = CHESS_EXTENDLL(pval,8);
    return chkapi_OK;
}
...
int [=getdesign_name=]_getp_DMb___uchar(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_get_DMb___sint(uicore,pval,addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getp_DMb___uchar");
...
int [=getdesign_name=]_getpalt_DMb___uchar(Checkers_uicore* uicore, unsigned long long& uval, AddressType& addr)
{
    ...
    int rt = [=getdesign_name=]_getalt_DMb___sint(uicore,pval,addr);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not get int value", "[=getdesign_name=]_getpalt_DMb___uchar");
    uval = CHESS_MASKLL(pval,8);
    return chkapi_OK;
}
...
static Ctp_access_fn acfns[] = {
...
#ifdef checkers_[=getdesign_name=]_RA_si
    { checkers_[=getdesign_name=]_RA_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RA_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RA_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RA_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RA_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RA_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RA_si
#ifdef checkers_[=getdesign_name=]_RB_si
    { checkers_[=getdesign_name=]_RB_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RB_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RB_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RB_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RB_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RB_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RB_si
#ifdef checkers_[=getdesign_name=]_RC_si
    { checkers_[=getdesign_name=]_RC_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RC_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RC_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RC_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RC_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RC_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RC_si
#ifdef checkers_[=getdesign_name=]_RD_si
    { checkers_[=getdesign_name=]_RD_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RD_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RD_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RD_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RD_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RD_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RD_si
#ifdef checkers_[=getdesign_name=]_RE_si
    { checkers_[=getdesign_name=]_RE_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RE_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RE_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RE_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RE_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RE_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RE_si
#ifdef checkers_[=getdesign_name=]_RF_si
    { checkers_[=getdesign_name=]_RF_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RF_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RF_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RF_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RF_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RF_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RF_si
#ifdef checkers_[=getdesign_name=]_RG_si
    { checkers_[=getdesign_name=]_RG_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RG_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RG_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RG_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RG_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RG_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RG_si
#ifdef checkers_[=getdesign_name=]_RH_si
    { checkers_[=getdesign_name=]_RH_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RH_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RH_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RH_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_RH_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_RH_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_RH_si
#ifdef checkers_[=getdesign_name=]_R11_si
    { checkers_[=getdesign_name=]_R11_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R11_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R11_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R11_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R11_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R11_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_R11_si
#ifdef checkers_[=getdesign_name=]_R12_si
    { checkers_[=getdesign_name=]_R12_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__cchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__schar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__uchar", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__sshort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__ushort", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__sint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__uint", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R12_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R12_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R12_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_R12_si, "__Pvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PPMvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_R12_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_R12_si
#ifdef checkers_[=getdesign_name=]_LC_si
...
#ifdef checkers_[=getdesign_name=]_LS_si
    { checkers_[=getdesign_name=]_LS_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    ...
    { checkers_[=getdesign_name=]_LS_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_LS_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_LS_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_LS_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    ...
    { checkers_[=getdesign_name=]_LS_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LS_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
#endif //checkers_[=getdesign_name=]_LS_si
#ifdef checkers_[=getdesign_name=]_LE_si
    { checkers_[=getdesign_name=]_LE_si, "bool", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    ...
    { checkers_[=getdesign_name=]_LE_si, "__slong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__ulong", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__slonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_LE_si, "__ulonglong", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_LE_si, "__ffloat", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__fdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    { checkers_[=getdesign_name=]_LE_si, "__flongdouble", [=getdesign_name=]_read1_record3, [=getdesign_name=]_write1_record3 },
    ...
    { checkers_[=getdesign_name=]_LE_si, "__PDMbvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__PDMhvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__PDMwvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__PDMb_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__PDMh_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "__PDMw_statvoid", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "w32", [=getdesign_name=]_read0, [=getdesign_name=]_write0 },
    { checkers_[=getdesign_name=]_LE_si, "int16p", [=getdesign_name=]_read0_pad16, [=getdesign_name=]_write0_pad16 },
...
int [=getdesign_name=]_chess_assert___slong(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___slong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert___ulong(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___ulong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert___slonglong(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_assert record value", "[=getdesign_name=]_chess_assert___slonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_assert record value", "[=getdesign_name=]_chess_assert___slonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert___ulonglong(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_assert record value", "[=getdesign_name=]_chess_assert___ulonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_assert record value", "[=getdesign_name=]_chess_assert___ulonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert___ffloat(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___ffloat");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert___fdouble(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_assert record value", "[=getdesign_name=]_chess_assert___fdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_assert record value", "[=getdesign_name=]_chess_assert___fdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert___flongdouble(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_assert record value", "[=getdesign_name=]_chess_assert___flongdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_assert record value", "[=getdesign_name=]_chess_assert___flongdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert___PDMbvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PDMbvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert___PDMhvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PDMhvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert___PDMwvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PDMwvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert___PDMb_statvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PDMb_statvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert___PDMh_statvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PDMh_statvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert___PDMw_statvoid(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert___PDMw_statvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_assert_w32(Checkers_uicore* uicore, int& oval)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert_w32");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_assert_int16p(Checkers_uicore* uicore, int& oval)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_assert value", "[=getdesign_name=]_chess_assert_int16p");
    val[0] |= CHESS_MASKLL(fval[0], 16) << 0;
    val[0] = CHESS_EXTENDLL(val[0],16);
    oval = val[0] != 0 ? 1 : 0;
    return chkapi_OK;
...
int [=getdesign_name=]_chess_report___slong(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___slong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
...
int [=getdesign_name=]_chess_report___ulong(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___ulong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
...
int [=getdesign_name=]_chess_report___slonglong(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_report record value", "[=getdesign_name=]_chess_report___slonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_report record value", "[=getdesign_name=]_chess_report___slonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
...
int [=getdesign_name=]_chess_report___ulonglong(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_report record value", "[=getdesign_name=]_chess_report___ulonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_report record value", "[=getdesign_name=]_chess_report___ulonglong");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
...
int [=getdesign_name=]_chess_report___ffloat(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___ffloat");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
    ...
    os << " //";
    chess_report_cycle_count(uicore, os);
    chess_report_expo(7, expo2dbl(val[0],32,2,8,3,0,0,0), os);
    os << std::endl;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_report___fdouble(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_report record value", "[=getdesign_name=]_chess_report___fdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_report record value", "[=getdesign_name=]_chess_report___fdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
    ...
    os << " //";
    chess_report_cycle_count(uicore, os);
    chess_report_expo(16, expo2dbl(val[0],64,2,11,3,0,0,0), os);
    os << std::endl;
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_report___flongdouble(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_report record value", "[=getdesign_name=]_chess_report___flongdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 32;
    // component 1 : 32 bits at 0
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(5));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_report record value", "[=getdesign_name=]_chess_report___flongdouble");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    /* complete */
...
int [=getdesign_name=]_chess_report___PDMbvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PDMbvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report___PDMhvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PDMhvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report___PDMwvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PDMwvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report___PDMb_statvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PDMb_statvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report___PDMh_statvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PDMh_statvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report___PDMw_statvoid(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report___PDMw_statvoid");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    os << "chess_report(void*):";
    chess_report_hex(32, (unsigned long long)val[0], os);
    os << " //";
...
int [=getdesign_name=]_chess_report_w32(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report_w32");
    val[0] |= CHESS_MASKLL(fval[0], 32) << 0;
    val[0] = CHESS_EXTENDLL(val[0],32);
...
int [=getdesign_name=]_chess_report_int16p(Checkers_uicore* uicore, std::ostream& os)
{
    ...
    rt = [=getdesign_name=]_read0_pad16(uicore, fval,1, chess_[=getdesign_name=]_R_si, AddressType(4));
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_report value", "[=getdesign_name=]_chess_report_int16p");
    val[0] |= CHESS_MASKLL(fval[0], 16) << 0;
    val[0] = CHESS_EXTENDLL(val[0],16);
...
int [=getdesign_name=]_chess_return_value___slong(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___slong");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___ulong(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___ulong");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___slonglong(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___slonglong");
    ...
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___slonglong");
...
int [=getdesign_name=]_chess_return_value___ulonglong(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit_component0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___ulonglong");
    vbit.deposit(vbit_component0, 63, 32);
    // component 1 : 32 bits at 0
    DataType vbit_component1(32, 0, 0);
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(51), at_addr), vbit_component1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___ulonglong");
    vbit.deposit(vbit_component1, 31, 0);
    /* complete */
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
...
int [=getdesign_name=]_chess_return_value___ffloat(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___ffloat");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___fdouble(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit_component0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___fdouble");
    vbit.deposit(vbit_component0, 63, 32);
    // component 1 : 32 bits at 0
    DataType vbit_component1(32, 0, 0);
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(51), at_addr), vbit_component1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___fdouble");
    vbit.deposit(vbit_component1, 31, 0);
    /* complete */
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
...
int [=getdesign_name=]_chess_return_value___flongdouble(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit_component0);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 0 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___flongdouble");
    vbit.deposit(vbit_component0, 63, 32);
    // component 1 : 32 bits at 0
    DataType vbit_component1(32, 0, 0);
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(51), at_addr), vbit_component1);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read component 1 of chess_return_value record value", "[=getdesign_name=]_chess_return_value___flongdouble");
    vbit.deposit(vbit_component1, 31, 0);
    /* complete */
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
...
int [=getdesign_name=]_chess_return_value___PDMbvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PDMbvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___PDMhvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PDMhvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___PDMwvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PDMwvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___PDMb_statvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PDMb_statvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___PDMh_statvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PDMh_statvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value___PDMw_statvoid(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value___PDMw_statvoid");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value_w32(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value_w32");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_chess_return_value_int16p(Checkers_uicore* uicore, DataType& ovbit)
{
    ...
    rt = chkapi_l_storage_get_vbit(uicore, Checkers_stor_addr(chess_[=getdesign_name=]_R_si, AddressType(41), at_addr), vbit);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read chess_return_value value", "[=getdesign_name=]_chess_return_value_int16p");
    ovbit.cloneFrom(vbit);
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_PM(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    for (int i = 0; i < nmemb; i++) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_PM");
        if (lsb_first)
...
int [=getdesign_name=]_write_word_ptr_PM(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    while (i != dta.end()) {
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_PM");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_PM(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (int i = 0; i < size*nmemb; i++) {
        ...
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_PM_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_PM");
...
int [=getdesign_name=]_write_ptr_PM(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        ...
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_PM_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_PM");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMb(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_DMb");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_DMb");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMb(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_DMb");
    ptr = CHESS_MASKLL(ptr,32);
    std::vector<unsigned char>::const_iterator i = dta.begin();
    while (i != dta.end()) {
        long long val = 0;
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_DMb");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMb(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_DMb");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_DMb");
        dta.push_back(val & 0xff);
        ptr += 1;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMb(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_DMb");
    ptr = CHESS_MASKLL(ptr,32);
    typedef std::vector<unsigned char>::const_iterator ucI;
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        long long val = *i;
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_DMb");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMh(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_DMh");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMh_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_DMh");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMh(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_DMh");
    ptr = CHESS_MASKLL(ptr,32);
    std::vector<unsigned char>::const_iterator i = dta.begin();
    while (i != dta.end()) {
        long long val = 0;
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_DMh");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMh(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_DMh");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMh_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_DMh");
        dta.push_back(val & 0xff);
        ptr += 2;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMh(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_DMh");
    ptr = CHESS_MASKLL(ptr,32);
    typedef std::vector<unsigned char>::const_iterator ucI;
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        long long val = *i;
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMh_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_DMh");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMw(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_DMw");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMw_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_DMw");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMw(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_DMw");
    ptr = CHESS_MASKLL(ptr,32);
    std::vector<unsigned char>::const_iterator i = dta.begin();
    while (i != dta.end()) {
        long long val = 0;
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_DMw");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMw(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_DMw");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMw_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_DMw");
        dta.push_back(val & 0xff);
        ptr += 4;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMw(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_DMw");
    ptr = CHESS_MASKLL(ptr,32);
    typedef std::vector<unsigned char>::const_iterator ucI;
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        long long val = *i;
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMw_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_DMw");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMb_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_DMb_stat");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_DMb_stat");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMb_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_DMb_stat");
    ptr = CHESS_MASKLL(ptr,32);
    std::vector<unsigned char>::const_iterator i = dta.begin();
    while (i != dta.end()) {
        long long val = 0;
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_DMb_stat");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMb_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_DMb_stat");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMb_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_DMb_stat");
        dta.push_back(val & 0xff);
        ptr += 1;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMb_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_DMb_stat");
    ptr = CHESS_MASKLL(ptr,32);
    typedef std::vector<unsigned char>::const_iterator ucI;
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        long long val = *i;
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMb_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_DMb_stat");
        ptr += 1;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMh_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_DMh_stat");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMh_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_DMh_stat");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMh_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_DMh_stat");
    ptr = CHESS_MASKLL(ptr,32);
    std::vector<unsigned char>::const_iterator i = dta.begin();
    while (i != dta.end()) {
        long long val = 0;
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_DMh_stat");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMh_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_DMh_stat");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMh_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_DMh_stat");
        dta.push_back(val & 0xff);
        ptr += 2;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMh_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_DMh_stat");
    ptr = CHESS_MASKLL(ptr,32);
    typedef std::vector<unsigned char>::const_iterator ucI;
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        long long val = *i;
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMh_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_DMh_stat");
        ptr += 2;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_word_ptr_DMw_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_word_ptr_DMw_stat");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMw_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read word from data pointer (output to host)", "tlx_read_word_ptr_DMw_stat");
        if (lsb_first)
            for(int j = 0; j < size; j++)
                dta.push_back(val >> j*8 & 0xff);
        else
...
int [=getdesign_name=]_write_word_ptr_DMw_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, int lsb_first, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_word_ptr_DMw_stat");
    ptr = CHESS_MASKLL(ptr,32);
    std::vector<unsigned char>::const_iterator i = dta.begin();
    while (i != dta.end()) {
        long long val = 0;
        ...
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write word to data pointer (input from host)", "tlx_write_word_ptr_DMw_stat");
        ptr += 4;
    }
    return chkapi_OK;
}
...
int [=getdesign_name=]_read_ptr_DMw_stat(Checkers_uicore* uicore, std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 56);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for reading output to host)", "[=getdesign_name=]_read_ptr_DMw_stat");
    ptr = CHESS_MASKLL(ptr,32);
    for (int i = 0; i < size*nmemb; i++) {
        long long val = 0;
        rt = [=getdesign_name=]_read0(uicore, &val,1, chess_[=getdesign_name=]_DMw_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not read byte from data pointer (output to host)", "tlx_read_ptr_DMw_stat");
        dta.push_back(val & 0xff);
        ptr += 4;
    }
    return chkapi_OK;
...
int [=getdesign_name=]_write_ptr_DMw_stat(Checkers_uicore* uicore, const std::vector<unsigned char>& dta, int size, int nmemb, AddressType hcvars)
{
    ...
    int rt = [=getdesign_name=]_read0_DMw(uicore, &ptr,1, chess_[=getdesign_name=]_DMb_si, hcvars + 60);
    if (rt != chkapi_OK)
        return chkapi_errorsp->put(rt, "Could not read data pointer (for writing input from host)", "[=getdesign_name=]_write_ptr_DMw_stat");
    ptr = CHESS_MASKLL(ptr,32);
    typedef std::vector<unsigned char>::const_iterator ucI;
    for (ucI i = dta.begin(); i != dta.end(); i++) {
        long long val = *i;
        rt = [=getdesign_name=]_write0(uicore, &val,1, chess_[=getdesign_name=]_DMw_stat_si, AddressType(ptr));
        if (rt != chkapi_OK)
            return chkapi_errorsp->put(rt, "Could not write byte to data pointer (input from host)", "tlx_write_ptr_DMw_stat");
        ptr += 4;
    }
    return chkapi_OK;
}
