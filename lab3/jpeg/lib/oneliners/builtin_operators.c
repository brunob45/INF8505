...
int  biopr___slonglong__lt(long long a, long long b) { return a < b; }
int  biopr___slonglong__gt(long long a, long long b) { return a > b; }
int  biopr___slonglong__le(long long a, long long b) { return a <= b; }
int  biopr___slonglong__ge(long long a, long long b) { return a >= b; }
int  biopr___slonglong__eq(long long a, long long b) { return a == b; }
int  biopr___slonglong__ne(long long a, long long b) { return a != b; }

int  biopr___slonglong__ltN(long long a) { return a < N; }
int  biopr___slonglong__gtN(long long a) { return a > N; }
int  biopr___slonglong__leN(long long a) { return a <= N; }
int  biopr___slonglong__geN(long long a) { return a >= N; }
int  biopr___slonglong__eqN(long long a) { return a == N; }
int  biopr___slonglong__neN(long long a) { return a != N; }
...
int  biopr___ulonglong__lt(unsigned long long a, unsigned long long b) { return a < b; }
int  biopr___ulonglong__gt(unsigned long long a, unsigned long long b) { return a > b; }
int  biopr___ulonglong__le(unsigned long long a, unsigned long long b) { return a <= b; }
int  biopr___ulonglong__ge(unsigned long long a, unsigned long long b) { return a >= b; }
int  biopr___ulonglong__eq(unsigned long long a, unsigned long long b) { return a == b; }
int  biopr___ulonglong__ne(unsigned long long a, unsigned long long b) { return a != b; }

int  biopr___ulonglong__ltN(unsigned long long a) { return a < N; }
int  biopr___ulonglong__gtN(unsigned long long a) { return a > N; }
int  biopr___ulonglong__leN(unsigned long long a) { return a <= N; }
int  biopr___ulonglong__geN(unsigned long long a) { return a >= N; }
int  biopr___ulonglong__eqN(unsigned long long a) { return a == N; }
int  biopr___ulonglong__neN(unsigned long long a) { return a != N; }
...
int  biopr___ffloat__lt(float a, float b) { return a < b; }
int  biopr___ffloat__gt(float a, float b) { return a > b; }
int  biopr___ffloat__le(float a, float b) { return a <= b; }
int  biopr___ffloat__ge(float a, float b) { return a >= b; }
int  biopr___ffloat__eq(float a, float b) { return a == b; }
int  biopr___ffloat__ne(float a, float b) { return a != b; }

int  biopr___ffloat__ltN(float a) { return a < N; }
int  biopr___ffloat__gtN(float a) { return a > N; }
int  biopr___ffloat__leN(float a) { return a <= N; }
int  biopr___ffloat__geN(float a) { return a >= N; }
int  biopr___ffloat__eqN(float a) { return a == N; }
int  biopr___ffloat__neN(float a) { return a != N; }
...
int  biopr___fdouble__lt(double a, double b) { return a < b; }
int  biopr___fdouble__gt(double a, double b) { return a > b; }
int  biopr___fdouble__le(double a, double b) { return a <= b; }
int  biopr___fdouble__ge(double a, double b) { return a >= b; }
int  biopr___fdouble__eq(double a, double b) { return a == b; }
int  biopr___fdouble__ne(double a, double b) { return a != b; }

int  biopr___fdouble__ltN(double a) { return a < N; }
int  biopr___fdouble__gtN(double a) { return a > N; }
int  biopr___fdouble__leN(double a) { return a <= N; }
int  biopr___fdouble__geN(double a) { return a >= N; }
int  biopr___fdouble__eqN(double a) { return a == N; }
int  biopr___fdouble__neN(double a) { return a != N; }


} //extern "C"  (186 functions)
