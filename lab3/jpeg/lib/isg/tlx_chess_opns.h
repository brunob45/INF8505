...
#endif//!
unsigned DUCbCr(unsigned, unsigned, unsigned, int, int, int &, int &);
void jpeg_fdct(int, int, int, int, int, int, int, int, int &, int &, int &, int &, int &, int &, int &, int &);
...
extern int float64_lt_quiet(tlx_primitive::dint, tlx_primitive::dint);
    ...
    inline void jpeg_fdct(int &a, int &b, int &c, int &d, int &e, int &f, int &g, int &h)
    {
