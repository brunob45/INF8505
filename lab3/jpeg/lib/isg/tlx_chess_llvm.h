...
#ifdef __cplusplus
struct chessout___uint_DUCbCr___uint___uint___uint___sint___sint___sint___sint {
    unsigned o0;
    int o1;
    int o2;
} __attribute__((packed));
extern __C__ __regcall struct chessout___uint_DUCbCr___uint___uint___uint___sint___sint___sint___sint chessintr___uint_DUCbCr___uint___uint___uint___sint___sint___sint___sint(unsigned, unsigned, unsigned, int, int) __attribute__((const));
inline __attribute__((always_inline,nodebug)) unsigned DUCbCr(unsigned a0, unsigned a1, unsigned a2, int a3, int a4, int &a5, int &a6) __attribute__((overloadable)) __attribute__((chessFP(llvm_local_block_replace_operand_with_variable)))
{
    struct chessout___uint_DUCbCr___uint___uint___uint___sint___sint___sint___sint out = chessintr___uint_DUCbCr___uint___uint___uint___sint___sint___sint___sint(a0, a1, a2, a3, a4);
    a6 = out.o2;
    a5 = out.o1;
    return out.o0;
}
...
#ifdef __cplusplus
struct chessout_void_jpeg_fdct___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint {
    int o1;
    int o2;
    int o3;
    int o4;
...
extern __C__ __regcall struct chessout_void_jpeg_fdct___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint chessintr_void_jpeg_fdct___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint(int, int, int, int, int, int, int, int) __attribute__((const));
inline __attribute__((always_inline,nodebug)) void jpeg_fdct(int a0, int a1, int a2, int a3, int a4, int a5, int a6, int a7, int &a8, int &a9, int &a10, int &a11, int &a12, int &a13, int &a14, int &a15) __attribute__((overloadable)) __attribute__((chessFP(llvm_local_block_replace_operand_with_variable)))
{
    struct chessout_void_jpeg_fdct___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint out = chessintr_void_jpeg_fdct___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint___sint(a0, a1, a2, a3, a4, a5, a6, a7);
    a15 = out.o8;
    a14 = out.o7;
    a13 = out.o6;
    a12 = out.o5;
...
#ifdef __cplusplus
    inline __attribute__((always_inline)) unsigned DUCbCr(unsigned R, unsigned G, unsigned B, int &Cb, int &Cr) __attribute__((overloadable))
    {
...
#ifdef __cplusplus
    inline __attribute__((always_inline)) void jpeg_fdct(int &a, int &b, int &c, int &d, int &e, int &f, int &g, int &h) __attribute__((overloadable))
    {
