...
CHESS_NATIVE_LINKAGE unsigned DUCbCr(unsigned a0, unsigned a1, unsigned a2, int a3, int a4, int & a5, int & a6)
{
    tlx_primitive::w32 p0 = a0;
    ...
    tlx_primitive::w32 p5; //output
    tlx_primitive::w32 p6; //output
    tlx_primitive::w32 t = tlx_primitive::DUCbCr(p0, p1, p2, p3, p4, p5, p6);
    a5 = toVBit(p5).value();
    a6 = toVBit(p6).value();
    unsigned r; r = toVBit(t).value();
    return r;
...
CHESS_NATIVE_LINKAGE void jpeg_fdct(int a0, int a1, int a2, int a3, int a4, int a5, int a6, int a7, int & a8, int & a9, int & a10, int & a11, int & a12, int & a13, int & a14, int & a15)
{
    tlx_primitive::w32 p0 = a0;
    tlx_primitive::w32 p1 = a1;
    tlx_primitive::w32 p2 = a2;
    ...
    tlx_primitive::w32 p8; //output
    tlx_primitive::w32 p9; //output
    ...
    tlx_primitive::jpeg_fdct(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15);
    a8 = toVBit(p8).value();
    a9 = toVBit(p9).value();
